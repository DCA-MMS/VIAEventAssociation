...
{
  private const string EventAsJson = """
                                     [
                                       {
    ...
    private static List<Event> CreateEvents()
    {
        ...
        return tempEvents.Select(tempEvent => new Event
        {
            Id = tempEvent.Id,
            Status = (int)Enum.Parse<EventStatus>(tempEvent.Status, true),
            Visibility = (int)Enum.Parse<EventVisibility>(tempEvent.Visibility, true),
            DurationStart = tempEvent.Start,
            DurationEnd = tempEvent.End,
            Capacity = tempEvent.MaxGuests,
