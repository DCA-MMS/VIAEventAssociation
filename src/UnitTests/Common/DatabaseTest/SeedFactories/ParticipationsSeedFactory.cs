...
public class ParticipationsSeedFactory
{
    ...
    private static List<TempParticipation>? GetParticipations()
    {
    ...
    public static void Seed(VeadatabaseContext context)
    {
        ...
        {
            AddParticipationsToEvents(context, eventId);
        }
    }
    
    private record TempParticipation(string EventId, string GuestId);
}